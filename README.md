# Trabajo Practico N°4: Sensor de movimiento
...
Mostrar un color Rojo cuando se detecte movimiento para indicar que el sistema está activo y que se prenda un buzzer. (con movimiento)
